            ...
            <div className="mx-5 grid grid-cols-1 lg:grid-cols-[1.4fr_1fr_1fr_1fr_1.4fr]">
                <div className="py-2 px-8 flex flex-col h-full">
                    ...
                    <div className="mt-auto flex items-center justify-center gap-3 pt-6">
                        <Link
                            href="#"
                            aria-label="LinkedIn"
                            className="flex h-10 w-10 items-center justify-center rounded-full border border-white/30 text-lg text-white/80 transition-all hover:border-[#FF9102] hover:text-[#FF9102]"
                        >
                ...
                <div className="border-l border-white/20 py-2 px-5">
                    ...
                    <div className="flex flex-col gap-0.5 text-sm text-gray-300">
                        ...
                        <Link href="/global-cyber-threat-map" className="hover:text-[#FF9102]">Global Cyber Threat Map</Link>
                        <Link href="/advisory-room" className="hover:text-[#FF9102]">Advisory Room</Link>
                        <Link href="/leadership-insights" className="hover:text-[#FF9102]">Leadership Insights</Link>
                        <Link href="/cyber-products" className="hover:text-[#FF9102]">Cyber Products</Link>
                        <Link href="/media-center" className="hover:text-[#FF9102]">Media Center</Link>
                    </div>
                </div>
                ...
                <div className="border-l border-white/20 py-2 px-5">
                    ...
                    <div className="flex flex-col gap-0.5 text-sm text-gray-300">
                        ...
                        <Link href="/newsletter" className="hover:text-[#FF9102]">Newsletter</Link>
                        <Link href="/podcast" className="hover:text-[#FF9102]">Podcast</Link>
                        <Link href="/events" className="hover:text-[#FF9102]">Events</Link>
                    </div>
                </div>
                ...
                <div className="border-l border-white/20 py-2 px-5">
                    ...
                    <div className="flex flex-col gap-0.5 text-sm text-gray-300">
                        ...
                        <Link href="/advertising-policy" className="hover:text-[#FF9102]">Advertising Policy</Link>
                        <Link href="/ethics-policy" className="hover:text-[#FF9102]">Ethics Policy</Link>
                        <Link href="/disclaimer" className="hover:text-[#FF9102]">Disclaimer</Link>
                    </div>
                </div>

                <div className="border-l border-white/20 py-2 px-8">
